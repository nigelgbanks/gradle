...
class LocalComponentDependencyMetadataTest extends Specification {
    ...
    def "returns this when same target requested"() {
        ...
        def dep = new LocalComponentDependencyMetadata(componentId, selector, "from", null, ImmutableAttributes.EMPTY, "to", [] as List, [], false, false, true, DependencyMetadataType.TRADITIONAL_DEPENDENCY, null)
    ...
    def "selects the target configuration from target component"() {
        def dep = new LocalComponentDependencyMetadata(componentId, Stub(ComponentSelector), "from", null, ImmutableAttributes.EMPTY, "to", [] as List, [], false, false, true, DependencyMetadataType.TRADITIONAL_DEPENDENCY, null)
    ...
    def "selects the target configuration from target component which matches the attributes"() {
        def dep = new LocalComponentDependencyMetadata(componentId, Stub(ComponentSelector), "from", null, ImmutableAttributes.EMPTY, null, [] as List, [], false, false, true, DependencyMetadataType.TRADITIONAL_DEPENDENCY, null)
    ...
    def "revalidates default configuration if it has attributes"() {
        def dep = new LocalComponentDependencyMetadata(componentId, Stub(ComponentSelector), "from", null, ImmutableAttributes.EMPTY, Dependency.DEFAULT_CONFIGURATION, [] as List, [], false, false, true, DependencyMetadataType.TRADITIONAL_DEPENDENCY, null)
...
Configuration 'default':
  - Incompatible attribute:
    ...
    def "revalidates explicit configuration selection if it has attributes"() {
        def dep = new LocalComponentDependencyMetadata(componentId, Stub(ComponentSelector), "from", null, ImmutableAttributes.EMPTY, 'bar', [] as List, [], false, false, true, DependencyMetadataType.TRADITIONAL_DEPENDENCY, null)
        def defaultConfig = defaultConfiguration()
        def toFooConfig = Stub(LocalConfigurationMetadata) {
            getName() >> 'foo'
            getAttributes() >> attributes(key: 'something')
...
Configuration 'bar':
  - Incompatible attribute:
    ...
    def "fails to select target configuration when not present in the target component"() {
        ...
        def dep = new LocalComponentDependencyMetadata(fromId, Stub(ComponentSelector), "from", null, ImmutableAttributes.EMPTY, "to", [] as List, [], false, false, true, DependencyMetadataType.TRADITIONAL_DEPENDENCY, null)
        def toComponent = Stub(ComponentResolveMetadata)
    ...
    def "applies exclude rules when traversing the from configuration"() {
        ...
        def moduleExclusions = new ModuleExclusions()
        def dep = new LocalComponentDependencyMetadata(componentId, Stub(ComponentSelector), "from", null, ImmutableAttributes.EMPTY, "to", [] as List, [exclude1, exclude2], false, false, true, DependencyMetadataType.TRADITIONAL_DEPENDENCY, null)

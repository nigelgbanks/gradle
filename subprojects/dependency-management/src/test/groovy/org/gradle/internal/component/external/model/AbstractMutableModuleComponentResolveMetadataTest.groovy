...
abstract class AbstractMutableModuleComponentResolveMetadataTest extends Specification {
    ...
    def "can attach variants with dependencies"() {
        ...
        !metadata.variants[0].dependencies[0].inheritSubgraphConstraints
        ...
        metadata.variants[0].dependencies[1].inheritSubgraphConstraints
        ...
        !metadata.variants[1].dependencies[0].inheritSubgraphConstraints

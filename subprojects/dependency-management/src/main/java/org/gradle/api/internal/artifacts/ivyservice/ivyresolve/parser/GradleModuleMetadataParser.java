...
public class GradleModuleMetadataParser {
    ...
    private void populateVariant(List<ModuleFile> files, List<ModuleDependency> dependencies, List<ModuleDependencyConstraint> dependencyConstraints, List<VariantCapability> capabilities, MutableComponentVariant variant) {
        ...
        for (ModuleDependency dependency : dependencies) {
            variant.addDependency(dependency.group, dependency.module, dependency.versionConstraint, dependency.excludes, dependency.reason, dependency.attributes, dependency.requestedCapabilities, dependency.inheritSubgraphConstraints);
        }
    ...
    private List<ModuleDependency> consumeDependencies(JsonReader reader) throws IOException {
        ...
        while (reader.peek() != END_ARRAY) {
            ...
            boolean inheritSubgraphConstraints = false;
            ...
            while (reader.peek() != END_OBJECT) {
                ...
                switch (name) {
                    ...
                    case "requestedCapabilities":
                        ...
                        break;
                    case "inheritSubgraphConstraints":
                        inheritSubgraphConstraints = reader.nextBoolean();
                        break;
                    default:
                        consumeAny(reader);
                        break;
            ...
            dependencies.add(new ModuleDependency(group, module, version, excludes, reason, attributes, requestedCapabilities, inheritSubgraphConstraints));
        }
        reader.endArray();
        return dependencies;
    }
    ...
    private static class ModuleDependency {
        ...
        final boolean inheritSubgraphConstraints;

        ModuleDependency(String group, String module, VersionConstraint versionConstraint, ImmutableList<ExcludeMetadata> excludes, String reason, ImmutableAttributes attributes, List<? extends Capability> requestedCapabilities, boolean inheritSubgraphConstraints) {
            this.group = group;
            this.module = module;
